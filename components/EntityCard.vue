      ...
      <div class="item-inner">
        ...
        <div class="card-info">
          ...
          <div class="flex gap-1 mt-1">
            <span v-if="attrs.isMagic" class="tag-badge tag--magic">
              <OhVueIcon name="gi-magic-palm" scale="0.7" /> Magic
            </span>
            <span v-if="attrs.isCursed" class="tag-badge tag--curse">
              <OhVueIcon name="fa-skull" scale="0.7" /> Cursed
            </span>
          </div>
          <div v-if="attrs.value" class="card-sub mt-1">
            <OhVueIcon name="gi-coins" scale="0.75" /> {{ attrs.value }}
          </div>
          <div class="card-date">edited {{ formatDate(entity.updatedAt) }}</div>
        </div>
      </div>
...
.tag--magic {
  background: rgba(168, 125, 232, 0.15);
  color: #a87de8;
  border: 1px solid rgba(168, 125, 232, 0.3);
}
