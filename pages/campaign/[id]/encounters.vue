<template>
  <div class="enc-page">
    ...
    <div class="page-content enc-content" v-if="!selectedEncounter" data-page="II">
      <p class="tome-intro"><em>Tactical encounters. Select one to open the battlefield, or begin a new engagement.</em>
      </p>
      <div class="index-list">
        <div v-for="enc in encounters" :key="enc.id" class="entry" @click="openEncounter(enc)">
          ...
          <span class="entry-tag"
            :style="enc.status === 'active' ? 'color:var(--blood);border-color:var(--blood)' : ''">
            {{ enc.status || 'prepared' }}
          </span>
        ...
        <div v-if="!encounters.length" class="tome-empty-inline"><em>No encounters yet. Write the first engagement.</em>
        </div>
      </div>
